...
c_list = [ 0.01, 0.1, 1, 10, 100, 500, 1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 10000 ]
for c in c_list:
    # split into training and testing data
    X_train, X_test, baseRent_train, baseRent_test = train_test_split(X, baseRent, test_size=0.20, random_state=9)
    
    # changing the epsilon value, e.g. 100, 200, etc.
    svr = SVR(kernel='rbf',C=c, epsilon=200).fit(X_train, baseRent_train)
    
    #produce test predictions
    baseRent_pred = svr.predict(X_test)
